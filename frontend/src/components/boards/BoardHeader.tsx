  ...
  return (
    <div className="relative overflow-hidden rounded-[28px] border border-[var(--border)] bg-[linear-gradient(135deg,rgba(45,212,191,0.22),rgba(17,17,24,0.96)_45%,rgba(99,102,241,0.26))] px-5 py-5 shadow-[var(--shadow-soft)] sm:px-6">
      ...
      <div className="relative flex min-h-[80px] flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
        <div>
          <p className="font-mono-ui text-[11px] uppercase tracking-[0.22em] text-white/65">Board</p>
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <button className="rounded-full border-white/10 bg-white/10 text-white hover:bg-white/15 px-4 py-2 text-sm flex items-center gap-2 transition">
            <Filter className="h-4 w-4" />
            Filters
          </button>
          <button
            className="rounded-full border border-white/10 bg-white/10 text-white hover:bg-white/15 p-2"
